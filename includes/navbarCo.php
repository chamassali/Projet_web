...
<body>
    ...
    <nav id="navbar-container">
        ...
        <div id="logo-container">
            <a href="index.php?id=<?php echo $_SESSION['id_users'] ?>"><img id="page-background-logo" src="../assets/images/logo.png" alt="Logo"></a>
        </div>
        ...
        <div id="navbar">
            <ul>
                ...
                <li id="user-icon-container"><a href="infoSite.php?id_users=<?php echo $_SESSION['id_users'] ?>"><i class="fas fa-question-circle user-icon"></i></a></li>
                ...
                <div>
                    <div>
                        <ul>
                            ...
                            <li><a href="contact.php?id_users=<?php echo $_SESSION['id_users'] ?>">Support</a></li>
                            <li id="user-icon-container"><a href="infoSite.php?id_users=<?php echo $_SESSION['id_users'] ?>"><i class="fas fa-question-circle user-icon"></i></a></li>
                            <li><a href="messagerie.php?id_users=<?php echo $_SESSION['id_users'] ?>"><i class="fas fa-comments"></i></a></li>
                            <li><a href="profil.php?id_users=<?php echo $_SESSION['id_users'] ?>"><i class="fas fa-user"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
